...
class PNR_STATUS:
    def __init__(self,root):
        ...
        pnr_instruction.place(x=0, y=330)
    ...
    # Retrieve the IRCTC ID entered by the user
        ...
        try:
            ...
            sql_query2 = "SELECT Train_Name FROM Train WHERE Train_Number = %s"
