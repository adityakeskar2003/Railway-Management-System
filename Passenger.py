...
class Passenger:
    def __init__(self,root,From=None,To=None,Train_Number=None,Date=None,Class=None,Day=None,total_price=None):
        ...
        box_frame = Frame(root, bg="white", height=600, width=720)
        box_frame.place(x=100, y=180)
