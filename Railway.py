...
def login(UserName,Password,self):
    # Check if the username and password are correct
        if UserName.get() == "admin" and Password.get() == "Aditya":
...
class Railway:
    def __init__(self,root):
        ...
        box_frame = Frame(root, bg="white", height=600, width=400)
        ...
        self.date_entry.place(x=130, y=320)
